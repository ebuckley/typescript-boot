...
logger_1.default.warn(path_1.default.join(__dirname, "../../dist/"));
app.use("/public", express_1.default.static(path_1.default.join(__dirname, "../../", "client/dist/"), { maxAge: 31557600000 }));
